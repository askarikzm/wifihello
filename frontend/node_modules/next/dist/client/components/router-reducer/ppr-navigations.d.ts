...
export declare function updateCacheNodeOnNavigation(oldCacheNode: CacheNode, oldRouterState: FlightRouterState, newRouterState: FlightRouterState, prefetchData: CacheNodeSeedData, prefetchHead: React.ReactNode, prefetchLayerAssets: React.ReactNode): Task | null;
...
export declare function updateCacheNodeOnPopstateRestoration(oldCacheNode: CacheNode, routerState: FlightRouterState): {
    ...
    layerAssets: import("react").ReactNode;
    prefetchLayerAssets: import("react").ReactNode;
