 ...
 */ function InnerLayoutRouter(param) {
    ...
    const layerAssets = (0, _react.useDeferredValue)(childNode.layerAssets, // @ts-expect-error The second argument to `useDeferredValue` is only
    // available in the experimental builds. When its disabled, it will always
    ...
    /*#__PURE__*/ (0, _jsxruntime.jsxs)(_approutercontextsharedruntime.LayoutRouterContext.Provider, {
        value: {
