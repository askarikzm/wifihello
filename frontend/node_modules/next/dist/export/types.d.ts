...
import type { NextEnabledDirectories, RequestLifecycleOpts } from '../server/base-server';
...
export type WorkerRenderOpts = WorkerRenderOptsPartial & RequestLifecycleOpts & LoadComponentsReturnType;
