...
Try changing the value to '${Math.ceil(e.revalidate)}' or using \`Math.ceil()\` if you're computing the value.`)}else if(!0===e.revalidate)t=1;else if(!1===e.revalidate||void 0===e.revalidate)t=!1;else throw Error(`A page's revalidate option must be seconds expressed as a natural number. Mixed numbers and strings cannot be used. Received '${JSON.stringify(e.revalidate)}' for ${n.url}`)}else t=!1;if(f.pageProps=Object.assign({},f.pageProps,"props"in e?e.props:void 0),v.revalidate=t,v.pageData=f,v.isNotFound)return new eE(null,{metadata:v})}if(M&&(f[R.uY]=!0),M&&!ep){let e;let t=!1;try{e=await (0,en.getTracer)().trace(eo.xj.getServerSideProps,{spanName:`getServerSideProps ${a}`,attributes:{"next.route":a}},async()=>M({req:n,res:s,query:i,resolvedUrl:l.resolvedUrl,...eb?{params:F}:void 0,...!1!==h?{draftMode:!0,preview:!0,previewData:h}:void 0,locales:l.locales,locale:l.locale,defaultLocale:l.defaultLocale}))}catch(e){throw"object"==typeof e&&null!==e&&"name"in e&&"message"in e&&"ENOENT"===e.code&&delete e.code,e}if(null==e)throw Error(C.Lx);e.props instanceof Promise&&(t=!0);let r=Object.keys(e).filter(e=>"props"!==e&&"redirect"!==e&&"notFound"!==e);if(e.unstable_notFound)throw Error(`unstable_notFound has been renamed to notFound, please update the field to continue. Page: ${a}`);if(e.unstable_redirect)throw Error(`unstable_redirect has been renamed to redirect, please update the field to continue. Page: ${a}`);if(r.length)throw Error(eK("getServerSideProps",r));if("notFound"in e&&e.notFound){if("/404"===a)throw Error('The /404 page can not return notFound in "getStaticProps", please remove it to continue!');return v.isNotFound=!0,new eE(null,{metadata:v})}if("redirect"in e&&"object"==typeof e.redirect&&(e0(e.redirect,n,"getServerSideProps"),e.props={__N_REDIRECT:e.redirect.destination,__N_REDIRECT_STATUS:er(e.redirect)},void 0!==e.redirect.basePath&&(e.props.__N_REDIRECT_BASE_PATH=e.redirect.basePath),v.isRedirect=!0),t&&(e.props=await e.props),(w||em)&&!N(a,"getServerSideProps",e.props))throw Error("invariant: getServerSideProps did not return valid props. Please report this.");f.pageProps=Object.assign({},f.pageProps,e.props),v.pageData=f}if(D&&!ef||v.isRedirect)return new eE(JSON.stringify(f),{metadata:v});if(ep&&(f.pageProps={}),V(s)&&!ef)return new eE(null,{metadata:v});let e4=E;if(ew&&eb){let e;let t=(e=(function(e){let t=/^\/index(\/|$)/.test(e)&&!J(e)?"/index"+e:"/"===e?"/index":z(e);{let{posix:e}=r("path"),n=e.normalize(t);if(n!==t)throw new Q("Requested and resolved page mismatch: "+t+" "+n)}return t})(a).replace(/\\/g,"/")).startsWith("/index/")&&!J(e)?e.slice(6):"/index"!==e?e:"/";t in e4.pages&&(e4={...e4,pages:{...e4.pages,[t]:[...e4.pages[t],...e4.lowPriorityFiles.filter(e=>e.includes("_buildManifest"))]},lowPriorityFiles:e4.lowPriorityFiles.filter(e=>!e.includes("_buildManifest"))})}let e2=({children:e})=>e$?e:(0,y.jsx)("div",{id:"__next",children:e}),e3=async()=>{let e,t;async function r(e){let t=async(t={})=>{if(eJ.err&&$)return e&&e(ea,ec),{html:await eQ((0,y.jsx)(e2,{children:(0,y.jsx)($,{error:eJ.err})})),head:eO};if(w&&(f.router||f.Component))throw Error("'router' and 'Component' can not be returned in getInitialProps from _app.js https://nextjs.org/docs/messages/cant-override-next-props");let{App:r,Component:n}="function"==typeof t?{App:ea,Component:t(ec)}:{App:t.enhanceApp?t.enhanceApp(ea):ea,Component:t.enhanceComponent?t.enhanceComponent(ec):ec},o=await e(r,n);return await o.allReady,{html:await ed(o),head:eO}},r={...eJ,renderPage:t},n=await X(el,r);if(V(s)&&!ef)return null;if(!n||"string"!=typeof n.html)throw Error(`"${G(el)}.getInitialProps()" should resolve to an object with a "html" prop set with a valid html string`);return{docProps:n,documentCtx:r}}el[R.wU];let n=(e,t)=>{let r=e||ea,n=t||ec;return eJ.err&&$?(0,y.jsx)(e2,{children:(0,y.jsx)($,{error:eJ.err})}):(0,y.jsx)(e2,{children:(0,y.jsx)(eW,{children:eY(r,n,{...f,router:eP})})})},o=async(e,t)=>{let r=n(e,t);return await function({ReactDOMServer:e,element:t,streamOptions:r}){return(0,en.getTracer)().trace(eo.k0.renderToReadableStream,async()=>e.renderToReadableStream(t,r))}({ReactDOMServer:P(),element:r})},a=!!el.getInitialProps,[i,l]=await Promise.all([eQ(e1()),(async()=>{if(a){if(null===(e=await r(o)))return null;let{docProps:t}=e;return t.html}{e={};let t=await o(ea,ec);return await t.allReady,ed(t)}})()]);if(null===l)return null;let{docProps:d}=e||{};return a?(t=d.styles,eO=d.head):(t=eR.styles(),eR.flush()),{contentHTML:i+l,documentElement:e=>(0,y.jsx)(el,{...e,...d}),head:eO,headTags:[],styles:t}};null==(u=(0,en.getTracer)().getRootSpanAttributes())||u.set("next.route",l.page);let e8=await (0,en.getTracer)().trace(eo.xj.renderDocument,{spanName:`render route (pages) ${l.page}`,attributes:{"next.route":l.page}},async()=>e3());if(!e8)return new eE(null,{metadata:v});let e9=new Set,e6=new Set;for(let e of ek){let t=T[e];t&&(e9.add(t.id),t.files.forEach(e=>{e6.add(e)}))}let e7=ej.hybrid,{assetPrefix:e5,buildId:te,customServer:tt,defaultLocale:tr,disableOptimizedLoading:tn,domainLocales:to,locale:ts,locales:ta,runtimeConfig:ti}=l,tl={__NEXT_DATA__:{props:f,page:a,query:i,buildId:te,assetPrefix:""===e5?void 0:e5,runtimeConfig:ti,nextExport:!0===eX||void 0,autoExport:!0===ew||void 0,isFallback:ep,isExperimentalCompile:et,dynamicIds:0===e9.size?void 0:Array.from(e9),err:l.err?(p=l.err,w?(g="server",g=p[eG]||"server",{name:p.name,source:g,message:eN()(p.message),stack:p.stack,digest:p.digest}):{name:"Internal Server Error.",message:"500 - Internal Server Error.",statusCode:500}):void 0,gsp:!!I||void 0,gssp:!!M||void 0,customServer:tt,gip:!!ev||void 0,appGip:!eg||void 0,locale:ts,locales:ta,defaultLocale:tr,domainLocales:to,isPreview:!0===m||void 0,notFoundSrcPage:eh&&w?eh:void 0},strictNextHead:l.strictNextHead,buildManifest:e4,docComponentsRendered:{},dangerousAsPath:eP.asPath,canonicalBase:!l.ampPath&&ee(n,"didStripLocale")?`${l.canonicalBase||""}/${l.locale}`:l.canonicalBase,ampPath:S,inAmpMode:e$,isDevelopment:!!w,hybridAmp:e7,dynamicImports:Array.from(e6),assetPrefix:e5,unstable_runtimeJS:j.unstable_runtimeJS,unstable_JsPreload:j.unstable_JsPreload,assetQueryString:ei,scriptLoader:eC,locale:ts,disableOptimizedLoading:tn,head:e8.head,headTags:e8.headTags,styles:e8.styles,crossOrigin:l.crossOrigin,optimizeCss:l.optimizeCss,optimizeFonts:l.optimizeFonts,nextConfigOutput:l.nextConfigOutput,nextScriptWorkers:l.nextScriptWorkers,runtime:K,largePageDataBytes:l.largePageDataBytes,nextFontManifest:l.nextFontManifest},td=(0,y.jsx)(L.Provider,{value:ej,children:(0,y.jsx)(Z.Provider,{value:tl,children:e8.documentElement(tl)})}),tu=await (0,en.getTracer)().trace(eo.xj.renderToString,async()=>eQ(td)),[tc,tp]=tu.split("<next-js-internal-body-render-target></next-js-internal-body-render-target>",2),th="";tu.startsWith(eV)||(th+=eV),th+=tc,e$&&(th+="<!-- __NEXT_DATA__ -->");let tf=th+e8.contentHTML+tp;return new eE(await o(a,tf,l,{inAmpMode:e$,hybridAmp:e7}),{metadata:v})}let e4=(e,t,r,n,o)=>e1(e,t,r,n,o,o),e2=w().createContext(null);function e3(e){let t=(0,x.useContext)(e2);t&&t(e)}class e8 extends v{constructor(e){super(e),this.components=e.components}render(e,t,r){return e1(e,t,r.page,r.query,r.renderOpts,{App:this.components.App,Document:this.components.Document})}}let e9={contexts:g},e6=e8})(),module.exports=n})();
