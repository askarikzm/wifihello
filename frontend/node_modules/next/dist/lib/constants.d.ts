...
declare const WEBPACK_LAYERS: {
    GROUP: {
        builtinReact: ("rsc" | "action-browser" | "app-metadata-route")[];
        serverOnly: ("middleware" | "rsc" | "action-browser" | "instrument" | "app-metadata-route")[];
        neutralTarget: "api"[];
        clientOnly: ("ssr" | "app-pages-browser")[];
        bundled: ("shared" | "rsc" | "ssr" | "action-browser" | "instrument" | "app-pages-browser" | "app-metadata-route")[];
    };
    shared: "shared";
