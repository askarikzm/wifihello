 ...
 */ function InnerLayoutRouter(param) {
    ...
    const layerAssets = useDeferredValue(childNode.layerAssets, // @ts-expect-error The second argument to `useDeferredValue` is only
    // available in the experimental builds. When its disabled, it will always
    ...
    /*#__PURE__*/ _jsxs(LayoutRouterContext.Provider, {
        value: {
