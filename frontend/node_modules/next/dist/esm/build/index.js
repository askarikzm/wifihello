...
import { detectConflictingPaths, computeFromManifest, getJsPageSizeInKb, printCustomRoutes, printTreeView, copyTracedFiles, isReservedPage, isAppBuiltinNotFoundPage, collectRoutesUsingEdgeRuntime } from './utils';
...
function createStaticWorker(config) {
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            async function turbopackBuild() {
                var _config_experimental, _config_experimental_turbo;
                if (!IS_TURBOPACK_BUILD) {
                ...
                const project = await bindings.turbo.createProject({
                    ...
                    memoryLimit: (_config_experimental_turbo = config.experimental.turbo) == null ? void 0 : _config_experimental_turbo.memoryLimit
                });
            ...
            if (!isCompileMode && (combinedPages.length > 0 || useStaticPages404 || useDefaultStatic500 || appDir)) {
                ...
                await staticGenerationSpan.traceAsyncFn(async ()=>{
                            ...
                            appStaticPaths.forEach((routes, originalAppPath)=>{
                                ...
                                routes.forEach((route, routeIdx)=>{
                                    defaultMap[route] = {
                                        ...
                                        _isDynamicError: (appConfig == null ? void 0 : appConfig.dynamic) === 'error',
                                        _isAppDir: true,
                                        _isRoutePPREnabled: appConfig ? checkIsRoutePPREnabled(config.experimental.ppr, appConfig) : undefined
                                    };
                                });
                            });
                            if (i18n) {
                    ...
                    for (const [originalAppPath, routes] of appStaticPaths){
                        ...
                        const experimentalPPR = !isRouteHandler && checkIsRoutePPREnabled(config.experimental.ppr, appConfig) ? true : undefined;
