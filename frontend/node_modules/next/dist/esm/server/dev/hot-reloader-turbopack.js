...
import { AssetMapper, formatIssue, getTurbopackJsConfig, handleEntrypoints, handlePagesErrorRoute, handleRouteType, hasEntrypointForKey, msToNs, processIssues, renderStyledStringToErrorAnsi, processTopLevelIssues, isWellKnownError, printNonFatalIssue, normalizeAppMetadataRoutePage } from './turbopack-utils';
...
export async function createHotReloaderTurbopack(opts, serverFields, distDir) {
    ...
    const hotReloader = {
        ...
        definition, isApp, url: requestUrl }) {
            ...
            const normalizedAppPage = normalizeAppMetadataRoutePage(page, extname(routeDef.filename));
