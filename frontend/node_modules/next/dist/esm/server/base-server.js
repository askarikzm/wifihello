...
import { handleBadRequestResponse, handleInternalServerErrorResponse } from './route-modules/helpers/response-handlers';
...
export default class Server {
   ...
   */ async prepare() {
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && isAppPageRouteModule(routeModule);
        ...
        const isRoutePPREnabled = couldSupportPPR && // In production, we'd expect to see the `experimentalPPR` flag set in the
        // prerender manifest.
        (((_this = prerenderManifest.routes[pathname] ?? prerenderManifest.dynamicRoutes[pathname]) == null ? void 0 : _this.experimentalPPR) === true || // Ideally we'd want to check the appConfig to see if this page has PPR
        ...
        const didPostpone = ((_cacheEntry_value = cacheEntry.value) == null ? void 0 : _cacheEntry_value.kind) === 'APP_PAGE' && typeof cacheEntry.value.postponed === 'string';
        ...
        if (onCacheEntry) {
            ...
            const finished = await onCacheEntry({
                ...
                value: {
                    ...cacheEntry.value,
                    kind: ((_cacheEntry_value1 = cacheEntry.value) == null ? void 0 : _cacheEntry_value1.kind) === 'APP_PAGE' ? 'PAGE' : (_cacheEntry_value2 = cacheEntry.value) == null ? void 0 : _cacheEntry_value2.kind
                }
            }, {
        ...
        if (!cachedData) {
            ...
            doRender({
                ...
                if (((_result_value = result.value) == null ? void 0 : _result_value.kind) !== 'APP_PAGE') {
                    var _result_value1;
