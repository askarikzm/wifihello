...
let startServerSpan;
export async function getRequestHandlers({ dir, port, isDev, server, hostname, minimalMode, isNodeDebugging, keepAliveTimeout, experimentalHttpsServer, quiet }) {
    return initialize({
        dir,
        port,
        hostname,
...
export async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"15.0.0-canary.35"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
