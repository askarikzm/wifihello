            ...
            if (!isCompileMode && (combinedPages.length > 0 || useStaticPages404 || useDefaultStatic500 || appDir)) {
                ...
                await staticGenerationSpan.traceAsyncFn(async ()=>{
                            ...
                            appStaticPaths.forEach((routes, originalAppPath)=>{
                                ...
                                routes.forEach((route, routeIdx)=>{
                                    defaultMap[route] = {
                                        ...
                                        _isAppDir: true,
                                        _isRoutePPREnabled: appConfig ? (0, _ppr.checkIsRoutePPREnabled)(config.experimental.ppr, appConfig) : undefined
                                    };
                                });
                            });
                            if (i18n) {
                    ...
                    for (const [originalAppPath, routes] of appStaticPaths){
                        ...
                        const experimentalPPR = !isRouteHandler && (0, _ppr.checkIsRoutePPREnabled)(config.experimental.ppr, appConfig) ? true : undefined;
