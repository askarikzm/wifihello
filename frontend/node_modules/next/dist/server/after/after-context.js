...
0 && (module.exports = {
    AfterContextImpl: null,
    createAfterContext: null
});
...
_export(exports, {
    AfterContextImpl: function() {
        return AfterContextImpl;
    },
    createAfterContext: function() {
...
class AfterContextImpl {
    ...
    addCallback(callback) {
        ...
        if (!this.requestStore) {
            throw new _invarianterror.InvariantError('unstable_after: Expected `AfterContext.requestStore` to be initialized');
        }
        if (!this.onClose) {
    ...
    async runCallbacks(requestStore) {
        ...
        return _requestasyncstorageexternal.requestAsyncStorage.run(readonlyRequestStore, ()=>{
            if (this.cacheScope) {
...
/** Disable mutations of `requestStore` within `after()` and disallow nested after calls.  */ function wrapRequestStoreForAfterCallbacks(requestStore) {
    return {
        ...
        mutableCookies: new _cookies.ResponseCookies(new Headers()),
