...
0 && (module.exports = {
    ...
    msToNs: null,
    normalizeAppMetadataRoutePage: null,
...
_export(exports, {
    ...
    normalizeAppMetadataRoutePage: function() {
        return normalizeAppMetadataRoutePage;
    },
        ...
        case 'app-route':
            {
                ...
                hooks == null ? void 0 : hooks.handleWrittenEndpoint(key, writtenEndpoint);
                const type = writtenEndpoint == null ? void 0 : writtenEndpoint.type;
                await manifestLoader.loadAppPathsManifest(normalizeAppMetadataRoutePage(page, false));
                if (type === 'edge') {
                    await manifestLoader.loadMiddlewareManifest(page, 'app');
                } else {
                    manifestLoader.deleteMiddlewareManifest(key);
...
function normalizeAppMetadataRoutePage(route, ext) {
